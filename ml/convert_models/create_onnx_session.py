...
# session = create_onnx_session('quantized_onnx_labse_model.onnx')
...
output = onnx_inference(
    'привет помните я вам предлагала скидку вот она три процента', session, tokenizer)
print(output)
